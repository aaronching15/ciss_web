...
##最早是从 20060801开始
obj_date["dict"]["date_start"] = "20090803" 
obj_date["dict"]["date_end"] ="20211231" # input("Type in date start such as 20190506: ")
...
for temp_i in df_date.index:
    ...
    if not cal_port_fund_unit == 1 : 
        ...
        ###############################################
        ### step 2.5.1,比较基金净值、重仓股、基础组合日收益率指标，

        class_fund_simu.cal_fund_stockpct_simu( obj_fund_ana,obj_port )
        # TODO C:\rc_HUARONG\rc_HUARONG\2020IAMAC课题\temp.xlsx
...
asd 
###############################################
### step 2.5.2,根据相关性等指标，确定股债比例



################################### 
### TODO:把基础组合净值、基金重仓组合、基金净值合并在一起，统一计算区间指标
