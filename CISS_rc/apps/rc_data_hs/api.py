...
### rc 
######################################## 
### 20211209：成功修改api.py,能提取 stock_quote_daily_list 的数据了
@args_check(
    check("en_prod_code").is_instance((str, None.__class__)),
    check("begin_date").is_instance((str, None.__class__)),
    check("end_date").is_instance((str, None.__class__)),
...
issue_price_change_rate	Float	16.4	距首发价涨跌幅	
    ...
    int_param =[]
    float_param =['trading_date','prev_close_price', 'open_price', 'high_price', 'low_price', 'close_price','avg_price',  'px_change', 'px_change_rate', 'turnover_ratio', 'business_balance','turnover_volume', 'issue_price_change', 'issue_price_change_rate']
    params = {
        "en_prod_code": en_prod_code,
        "begin_date": convert_date(begin_date),
        "end_date": convert_date(end_date),
    ...
    return get_data("stock_quote_daily_list", url_path="market_info", **params)
