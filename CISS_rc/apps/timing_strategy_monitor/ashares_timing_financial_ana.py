...
--------------------------------------------
功能
必须消费产业链；1，过去2个季度财务数据选股；2，择时配置：diff_timing= timing_mvfloat - timing_ew ；
steps：
...
obj_financial["dict"] ={}
# "rc_2005"
obj_financial["dict"]["id_output"] = "rc_0718_indcode_28" 
...
'''33	家电;34	纺织服装;35	医药;36	食品饮料;37	农林牧渔;40	银行;41	非银行金融;42	房地产;43	综合金融;
50	交通运输;60	电子;61	通信;62	计算机;63	传媒 ；28	国防军工'''
obj_financial["dict"]["single_industry"] = 28
### 若单个一级行业，则取行业内前50%;默认前30%；若indi_quantile_tail=1, 则取尾部指标值，默认值0取指标最大的。
obj_financial["dict"]["indi_quantile_tail"] = 0 # 1
obj_financial["dict"]["date_start"] = "20060101" # input("Type in date start such as 20151101: ")
obj_financial["dict"]["date_end"] ="20200718" # input("Type in date start such as 20190506: ")
...
date_list_after_ann = date_list_after_ann +[ obj_financial["dict"]["date_end"] ]
### 新建df，保存未来一期组合收益：
...
for temp_date_start in date_list_after_ann:
    ...
    2.2，单一个股权重不超过10%
    '''
    ### 设置必选行业：如：电子、建材、计算机、医药、基础化工、通信、农林牧渔；60 24 62 35 22 61 37。
    obj_data["dict"]["ind_fixed"] = [60.0,62.0,35.0,61.0,37.0,36.0,33.0,41.0  ]
    ...
    obj_data["dict"]["ashare_weight_max"] = 0.1
